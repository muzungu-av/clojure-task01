...
(def student-tbl (csv/parse-csv (slurp (io/resource "student.csv"))))
(def subject-tbl (csv/parse-csv (slurp (io/resource "subject.csv"))))
(def student-subject-tbl (csv/parse-csv  (slurp (io/resource "student_subject.csv"))))
...
(defn str-field-to-int [field rec]
   (update rec field #(parse-int %)))                                        ;update rec field
